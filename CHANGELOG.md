...
- Tactical combat unit clicks no longer open a blocking inspection card over the spawn row, and selecting another party unit remains available while the current unit is choosing a target.
