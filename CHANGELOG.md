...
- Professor Mari now keeps one integrated animated presence in the workspace header while a single live transcript row reports her current work, replacing repeated mascot artwork and the separate working card; the header foregrounds her current subject and moves Chats, Skills, Memories, Context, and Restart into one panel menu; decisions use the companion work panel beside her explanation on desktop and as a focused sheet on mobile instead of crowding the composer.
