...
| Android 휴대폰 또는 태블릿 | [Android (Termux) 설치](installation/android-termux.md) |
...
- **Android**에서는 Marinara가 **Termux** 안에서 실행됩니다. Termux는 Android에 작은 Linux 환경을 만들어 주는 무료 앱입니다. 릴리스 APK는 Termux 설정을 도와주는 역할만 합니다.
