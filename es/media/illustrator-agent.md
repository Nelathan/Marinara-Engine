...
El Illustrator no dibuja cada mensaje. De forma predeterminada, después de crear una imagen espera unas 5 respuestas aceptadas del asistente antes de poder crear otra. Hacer swipe (respuesta alternativa) o regenerar la misma respuesta no avanza ese intervalo. Si decide que un momento no vale la pena ilustrar, lo omite y no crea ninguna imagen. Cada imagen que crea se guarda en la **Gallery** (Galería) del chat.
