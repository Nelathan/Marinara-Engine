...
| `CSRF_TRUSTED_ORIGINS`                  | leer              | Zusätzliche Browser-Ursprünge, die Änderungen speichern dürfen. Nützlich bei einer öffentlichen Domain oder einem ungewöhnlichen Port.                       |
