...
Der Illustrator zeichnet nicht zu jeder Nachricht. Standardmäßig wartet er nach einem Bild rund 5 angenommene KI-Antworten ab, bevor das nächste entstehen kann. Swipes oder neu generierte Fassungen derselben Antwort zählen dabei nicht mit. Hält er einen Moment nicht für bildwürdig, überspringt er ihn und erzeugt kein Bild. Jedes fertige Bild landet in der **Gallery** (Galerie) des Chats.
